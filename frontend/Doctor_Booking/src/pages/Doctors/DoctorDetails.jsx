                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-[6px]">
                                    ...
                                    lg:text-[16px] lg:leading-7 font-semibold text-headingColors"
                                    >
                                ...
                                <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus veniam eos dolor
                                    ut et aspernatur odio voluptatem saepe explicabo accusamus? Qui ab odit cum fugit,
                                    itaque eligendi! Nostrum, repellat numquam.
                                </p>
                            </div>
                        </div>
